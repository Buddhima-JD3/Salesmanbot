...
class HtmlFormatter(Formatter):
    ...
    .. sourcecode:: html
        ...
        <table><tr>
          <td className="linenos" title="click to toggle"
          ...
          <td className="code">
            <pre><span className="Ke">def </span><span className="NaFu">foo</span>(bar):
              <span className="Ke">pass</span>
            </pre>
          </td>
        </tr></table></div>
    ...
    **Subclassing the HTML formatter**
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        if self.filename:
            filename_tr = (
                '<tr><th colspan="2" className="filename"><div className="highlight">'
                '<span className="filename">' + self.filename + '</span></div>'
                '</th></tr>')
        ...
        yield 0, (
            '<table className="%stable">' % self.cssclass + filename_tr +
            '<tr><td className="linenos"><div className="linenodiv"><pre>' +
            ls + '</pre></div></td><td className="code">'
        )
    ...
    def _wrap_inlinelinenos(self, inner):
        ...
        for _, inner_line in inner_lines:
            ...
            if nocls:
                ...
                if special_line:
                    style = ' className="linenos special"'
                else:
                    style = ' className="linenos"'
    ...
    def _wrap_div(self, inner):
        ...
        yield 0, ('<div' + (self.cssclass and ' className="%s"' % self.cssclass) +
    ...
    def _wrap_pre(self, inner):
        ...
        if self.filename and self.linenos != 1:
            yield 0, ('<span className="filename">' + self.filename + '</span>')
        ...
        for ttype, value in tokensource:
            try:
                ...
                if nocls:
                    ...
                    if css_class:
                        cspan = '<span className="%s"%s>' % (css_class, title)
                    else:
                        cspan = ''
        ...
        for i, (t, value) in enumerate(tokensource):
            ...
            if i + 1 in hls:  # i + 1 because Python indexes start at 0
                if self.noclasses:
                    ...
                    yield 1, '<span className="hll">%s</span>' % value
            else:
                yield 1, value
