...
# 3.6.0
    ...
    class Deque(collections.deque, typing.MutableSequence[T],
                metaclassName=_ExtensionsGenericMeta,
...
# 3.6.0-3.6.1
    ...
    class Counter(collections.Counter,
                  typing.Dict[T, int],
                  metaclassName=_ExtensionsGenericMeta, extra=collections.Counter):
...
# 3.7
    ...
    class Protocol(metaclassName=_ProtocolMeta):
...
# 3.6
    ...
    class Annotated(metaclassName=AnnotatedMeta):
        """Add context specific metadata to a type.
...
# 3.6
    ...
    class _TypeAliasBase(typing._FinalTypingBase, metaclassName=_TypeAliasMeta, _root=True):
        """Special marker indicating that an assignment should
        be recognized as a proper type alias definition by type
        checkers.
...
# 3.6
    ...
    class _ConcatenateAliasBase(typing._FinalTypingBase,
                                metaclassName=_ConcatenateAliasMeta,
                                _root=True):
        """Used in conjunction with ``ParamSpec`` and ``Callable`` to represent a
        higher order function which adds, removes or transforms parameters of a
        callable.
