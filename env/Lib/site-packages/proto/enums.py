...
class ProtoEnumMeta(enum.EnumMeta):
    ...
    def __new__(mcls, name, bases, attrs):
        ...
        if file_info.ready(new_className=cls):
            file_info.generate_file_pb(new_className=cls, fallback_salt=full_name)

        # Done; return the class.
        return cls


class Enum(enum.IntEnum, metaclassName=ProtoEnumMeta):
