...
class ServerInterceptor(metaclassName=ABCMeta):
...
class ClientInterceptor(metaclassName=ABCMeta):
    """Base class used for all Aio Client Interceptor classes"""


class UnaryUnaryClientInterceptor(ClientInterceptor, metaclassName=ABCMeta):
...
class UnaryStreamClientInterceptor(ClientInterceptor, metaclassName=ABCMeta):
...
class StreamUnaryClientInterceptor(ClientInterceptor, metaclassName=ABCMeta):
...
class StreamStreamClientInterceptor(ClientInterceptor, metaclassName=ABCMeta):
