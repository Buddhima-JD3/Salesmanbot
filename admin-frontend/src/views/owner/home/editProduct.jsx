                        ...
                        <Form>
                            <div className="row mb-4">
                                <div className="col">
                                    <div className="form-group">
                                        <label style={{fontWeight: 'bold', color: '#5D5D5D'}} className="form-label">*Product
                                            Name</label>
                                        <Field type="text" name="name" id="name" className="form-control"
                                               placeholder="Product name"/>
                                        {errors.name && touched.name ?
                                            <p id={"login-error"} className="text-danger mt-1">{errors.name}</p> : null}
                                    </div>
                                </div>
                                <div className="col">
                            ...
                            <div className="form-outline mb-4">
                                ...
                                <textarea className="form-control" id="description" name="description" rows="5"
                                          defaultValue={products.description} placeholder="Enter Product Description"
                                          onChange={(e) => {
                                ...
                                <center>
                                    <button style={{marginRight: '10px'}} type="submit" className="btn btn-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             fill="currentColor" className="bi bi-cloud-download" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <button type="submit" className="btn btn-danger" onClick={deleteProduct}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
