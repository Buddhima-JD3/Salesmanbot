                ...
                <div className="showcase-area">
                    <div className="container">
                        <div className="left">
                            ...
                            <p className="text">
                                Ideal for supermarkets and shopping malls. Customers can interact virtually and
                                physically with the product.
                                The product is used for negotiation on certain occasions with the aid of ontology.
                            </p>
                            <p className="text">
                                The goal is to make business more efficient by using ontology-based negotiation through
                                a salesman-bot.
                                Salesman-bot makes service more reliable and easier for people using supermarkets,
                                shopping malls, and eCommerce.
                            </p>
                            <div className="cta">

                                <Link>
                                    <li href="#" onClick={redirectPage} className="btn2">Get started</li>
                                </Link>
                        ...
                        <div className="right">
                            <img
                                src="https://i.postimg.cc/4yYBmhFD/0c428e8239727076ce2e1716b1ee529eff79ad34466fea57e80c3ebc4336a019821c607b17d5ada3-car-202x158.gif"/>
                        </div>
                        <row></row>
                    </div>
                </div>
